...
module.exports = function (app) {
    ...
    // menu dia listado webCliente
    app.get('/usuario/datatiporanchowebCliente/:idcomedor/:idreparto', Procesos.menudiawebCliente)
    ...
    app.get('/usuario/dataRestaurant_reparto/:idreparto_', Procesos.Repartocomedor)
