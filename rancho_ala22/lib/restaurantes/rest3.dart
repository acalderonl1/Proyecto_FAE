...
class Resta3 extends StatefulWidget {
  const Resta3({Key key, this.idcliente}) : super(key: key);
  final int idcliente;
  @override
  _ListaRe createState() => _ListaRe();
}
...
/*  Uri.parse(
            'http://192.168.68.116:3000/usuario/dataRestaurant_reparto/1'), //url
        headers: {"Accept": "application/json"});*/
class _ListaRe extends State<Resta3> {
