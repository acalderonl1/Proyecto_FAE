        ...
        if (usuario_login.length > 0) {
            if (usuario_login[0].dataValues.contrasena == req.params.contrasena) {
                res.json(
                    {
                        "msg": "1",
                        "id_user":usuario_login[0].dataValues.id_user,
                        "nombre":usuario_login[0].dataValues.nombre,
                        "apellido":usuario_login[0].dataValues.apellido,
                        "correo":usuario_login[0].dataValues.correo,
                        "fecha_creacion":usuario_login[0].dataValues.fecha_creacion
                    }
                )
            } else {
                res.json(
