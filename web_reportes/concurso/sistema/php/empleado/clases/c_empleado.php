                ...
                if ($data) {
                    ...
                    if (move_uploaded_file($_FILES['foto']['tmp_name'], $carpeta . $nombreFinal)) {
                        ...
                        if ($tb_empleados) {
                            ...
                            // $tb_usuarios = '1';
                            $tb_usuarios = Conexion::UpdateRegistro("INSERT INTO tb_usuarios (cod_usuario,cod_rol,usuario,correo,password,foto,estado,conexion,usuario_creado,fecha_creado) VALUES  ('" . htmlentities($cod_usuario) . "',2,'" . htmlentities($usuario) . "','" . htmlentities($correo) . "', '" . htmlentities($pass) . "','" . htmlentities($nombreFinal) . "','A','D','" . htmlentities($iduser) . "',now())");
                            if ($tb_usuarios) {
