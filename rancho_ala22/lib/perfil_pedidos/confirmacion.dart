...
class Confirmacion extends StatefulWidget {
  @override
  confirma createState() => confirma();
}

class confirma extends State<Confirmacion> {
  @override
      ...
      body: SingleChildScrollView(
        child: new Column(
          ...
          children: <Widget>[
            ...
            Text(
              "Felicidades haz realizado con exito la reserva",
              style: TextStyle(
                  fontFamily: 'OpenSans',
            ...
            Center(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage('assets/images/celebracion.png'))),
            )),
            SizedBox(
              height: 30,
            ),
